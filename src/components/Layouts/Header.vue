<template>
  <header>
    <nav class="mx-auto flex w-full max-w-7xl items-center justify-between p-4">
      <figure>
        <svg
      ...
      <ul class="flex items-center justify-between gap-4 text-textHeading">
        <li>
          Home
        ...
        <li>
          Shows
          <!-- <router-link to="/about">TV Shows</router-link> -->
        </li>

        <li>
          New & Popular
          <!-- <router-link to="/users">New & Popular</router-link> -->
        </li>
      </ul>
      <div class="flex items-center justify-between gap-3">
        <figure class="text-textHeading">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
            height="1em"
          ...
          >
            <path
              fill="currentColor"
              d="M2.43 4.8L0 7.222L12 19.2L24 7.222L21.57 4.8L12 14.347z"
            />
          </svg>
        </figure>
        <button
          class="rounded-lg bg-gradient-to-br from-[#BC0E19] to-[#DB202C] px-6 py-2 text-textHeading"
        >
          Masuk
        </button>
      </div>
